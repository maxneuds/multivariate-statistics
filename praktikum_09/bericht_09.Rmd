...
So beträgt beispielsweise der Regressionskoeffizient für BMI `r log_reg$coefficients[3]`. Dies deutet darauf hin, dass eine Erhöhung des BMI um 5 Einheiten die Wahrscheinlichkeit, an Diabetes erkrankt um `r round(1 - 1 / exp(log_reg$coefficients[3] * 5), 2)`% erhöht $1 - 1 / \exp(5 \beta_{\operatorname{BMI}})$.
