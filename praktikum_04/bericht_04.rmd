...
Wir erhalten einen Testwert von `r round(test, 2)` und dieser liegt nicht im Ablehnungsbereich `r round(t_value, 2)`. Folglich lehnen wir die Nullhypothese nicht ab.
